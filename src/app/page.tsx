...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 w-full relative z-10 text-center">
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center w-full sm:w-auto">
              <a
                href="https://apps.apple.com/au/app/blotztask-adhd-time-manager/id6752492404"
                target="_blank"
              ...
              >
                ...
                <span className="flex-1 text-center font-sans text-lg font-black tracking-tight">
                  App Store
                </span>
              </a>
              <a
                href="https://play.google.com/store/apps/details?id=com.blotz.blotztask&hl=en"
                target="_blank"
                rel="noopener noreferrer"
                className="flex w-52 sm:w-64 items-center justify-center pl-12 sm:pl-14 py-3 sm:py-4 bg-white text-primary rounded-3xl font-black shadow-xl active:scale-95 group btn-hover-glow hover:shadow-2xl transition-all border-2 border-white relative"
              >
      ...
      <section
        id="features"
        className="py-12 lg:py-20 bg-gradient-to-br from-primary/5 via-transparent to-secondary/5"
      >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mb-6 overflow-hidden rounded-2xl">
                    <video
                      src={
                        isEn
                          ? "/videos/calendar-page-video-en.mp4"
                          : "/videos/calendar-page-video.mp4"
                      }
                      autoPlay
                      muted
                      loop
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mb-6 overflow-hidden rounded-2xl">
                    <video
                      src={
                        isEn
                          ? "/videos/star-spark-video-en.mp4"
                          : "/videos/star-spark-video.mp4"
                      }
                      autoPlay
                      muted
                      loop
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mb-6 overflow-hidden rounded-2xl">
                    <video
                      src={
                        isEn
                          ? "/videos/break-down-video-en.mp4"
                          : "/videos/break-down-video.mp4"
                      }
                      autoPlay
                      muted
                      loop
      ...
      <section
        id="socialmedia"
        className="py-12 lg:py-20 bg-gradient-to-br from-primary/5 via-transparent to-secondary/5 overflow-hidden relative"
      >
            ...
            <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
              ...
              <ScrollReveal delay={300} animation="scale">
                ...
                >
                  ...
                  <h4 className="text-xl font-black text-foreground mb-2">
                    {t("socialLinkedinTitle")}
                  </h4>
                  <p className="text-sm text-muted-foreground mb-6">
                    {t("socialLinkedinDesc")}
                  </p>
